        ...
        Box(
            modifier = Modifier
                ...
                .background(
                    brush = Brush.verticalGradient(
                        colors = listOf(Color(0xFFECF3FF), Color(0xFFD7E5FF), Color(0xFFC8DCF8))
                    )
                )
                .padding(8.dp)
        ) {
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Buscar meta por título") },
        ...
        Dialog(onDismissRequest = onDismiss) {
            Surface(
                ...
                Column(modifier = Modifier.padding(12.dp)) {
                    Text("Nueva Meta", style = MaterialTheme.typography.titleLarge, fontWeight = FontWeight.Bold)

                    PrimaryTabRow(selectedTabIndex = selectedTab) {
                        Tab(selected = selectedTab == 0, onClick = { selectedTab = 0 }, text = { Text("Personalizada") })
                        Tab(selected = selectedTab == 1, onClick = { selectedTab = 1 }, text = { Text("Hábitos") })
                        Tab(selected = selectedTab == 2, onClick = { selectedTab = 2 }, text = { Text("Programas") })
                    }
