...
class FragNotas : Fragment() {
    ...
    override fun onStart() {
        super.onStart()
        MainActivity.currentInstance()?.ic_toolsBar_frase_add?.visibility = View.GONE
        MainActivity.currentInstance()?.ic_toolsBar_nota_add?.visibility = View.GONE
        MainActivity.currentInstance()?.ic_toolsBar_fav?.visibility = View.GONE
    }

    override fun onStop() {
        super.onStop()
        MainActivity.currentInstance()?.ic_toolsBar_frase_add?.visibility = View.VISIBLE
        MainActivity.currentInstance()?.ic_toolsBar_nota_add?.visibility = View.VISIBLE
    }
