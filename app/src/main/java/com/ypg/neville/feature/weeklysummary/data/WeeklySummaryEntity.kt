...
data class WeeklySummaryEntity(
    ...
    val eveningRitualsCompleted: Int,
    val ritualCyclesCompleted: Int,
    val eveningAverageEnergy: Int,
    val eveningAverageIdentityAlignment: Int,
    val eveningPresenceReturns: Int,
    val eveningGoalUnitsCompleted: Int,
    val cardioCoherenceSessions: Int,
    val cardioCoherenceMinutes: Int,
    val cardioCoherenceScoreDelta: Int,
